$(document).ready(function() {
    // イベントリストの追加
    $('#event-list').append('<li>桜美林学園での文化祭1日目に中学、高校入試予想問題計48部すべて配布完了いたしました。<br>ご来場いただいた皆様に感謝いたします。<br>こちらの問題は数学同好会が過去の問題の傾向を調査して作成した問題ですので、実際の入試問題とは一切関係ありません。<br>中学入試問題の問題にいくつか、間違いがありましたので後日こちらのホームページで解答を配信する際に訂正した問題を配信する予定です。<br>そのため、2日目の問題配布は高校入試のみとさせていただきます。<br>誠に申し訳ございません。</li>');
