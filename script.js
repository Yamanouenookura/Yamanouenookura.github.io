$(document).ready(function() {
    // イベントリストの追加
    $('#event-list').append('<li>文化祭でご来場いただいた皆様誠にありがとうござました。私たちはこれからも数学の楽しさと、奥深さを皆様に伝えられるよう精進してまえります。</li>');
    ...
    // ニュースリストの追加
    $('#news-list').append('<li><a href="高校_解答解説.pdf" download="高校_解答解説">自作高校問題解答と解説</a></li>');
